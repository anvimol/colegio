@if ($editar)
	...
	<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
		...
		{!!Form::text('apellidos',null,['class'=>'form-control','placeholder'=>'Apellidos del alumno...'])!!}
	</div>
	...
	<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
		...
		{!!Form::text('codigo_postal',null,['class'=>'form-control','placeholder'=>'Nombre del alumno'])!!}
	</div>
