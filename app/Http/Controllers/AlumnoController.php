...
class AlumnoController extends Controller
{
    ...
    public function index(Request $request)
    {
...

        {
            ...
            ->where ('tipo_persona','=','Alumno')
            ->orwhere('dni','LIKE','%'.$query.'%')
            ->where ('tipo_persona','=','Alumno')
            ->orderBy('id','desc')
            ->paginate(7);
            return view('admin.alumnos.index',["personas"=>$personas,"searchText"=>$query]);
        }
    }
    ...
    {   
        $editar = false;
        return view('admin.alumnos.create', ['editar' => $editar]);
    }
    ...
    public function edit($id)
    {
        ...
        $editar = true;
        return view("admin.alumnos.edit",["persona"=>$persona, 'editar' => $editar]);
    }
